        ...
        backend.connections.subscribe((connection: MockConnection) => {
            ...
            setTimeout(() => {
                ...
                if (connection.request.url.match(/\/api\/users\/\d+$/) && connection.request.method === RequestMethod.Get) {
                 ...
                 // check user
                if (connection.request.url.endsWith('/api/forgot') && connection.request.method === RequestMethod.Post) {
                    ...
                    if (!duplicateUser) {
                        return connection.mockError(new Error('Email "' + newUser.email + '" is not taken'));
                    }
