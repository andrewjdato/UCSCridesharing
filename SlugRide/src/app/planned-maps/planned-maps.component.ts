...
@Component({
  selector: 'app-planned-maps-submit',
  templateUrl: './planned-maps.component.html',
  styleUrls: ['./planned-maps.component.css'],
  providers: [GoogleMapsAPIWrapper]
})

export class PlannedMapsComponent implements OnInit {
