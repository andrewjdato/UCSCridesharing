...
class RSCell: DatasourceCell {
    ...
    override func setupViews() {
        ...
        nameLabel.anchor(self.topAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, topConstant: 4, leftConstant: 8, bottomConstant: 0, rightConstant: 12, widthConstant: 0, heightConstant: 20)
...
class RSViewController: DatasourceController {
